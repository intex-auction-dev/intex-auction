  ...
  venue: {
    ...
    auction: {
      ...
      params: {
        ...
        issuanceEntryPrices: [1_000_000n, 34_000_000n],
        strikeAmountsMinor: [100_000n * 10n ** 6n],
        oraclePairIds: [1, 2],
        referenceCurrency: 840,
        promisLoadMinor: 100_000n * 10n ** 6n,
        minIntexBidRate: 600_000,
        minIntexBidQuantity: 1,
        entryPriceMinor: 1_000_000n,
        floorPriceMinor: 1_080_000n,
        callPriceMinor: 2_280_000n,
        commitBondMinor: 10n,
        callTrigger: {
          windowDays: 30,
          thresholdDays: 21,
